...
<body class="min-h-screen bg-gray-50">
    ...
    <main class="flex flex-col justify-center p-6 pb-12">
        <div class="mx-auto max-w-md">
            <svg class="mx-auto h-12 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <div class="mx-auto mt-6 w-full max-w-md rounded-xl bg-white/80 p-6 shadow-xl backdrop-blur-xl sm:mt-10 sm:p-10">
            <form action="{{ route('login') }}" method="post" novalidate autocomplete="off">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative mt-1 rounded-md shadow-sm">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus class="{{ $errors->has('email') ? 'text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 border-red-300' : 'border-gray-300 focus:border-green-500 focus:ring-green-500 placeholder:text-gray-400' }} w-full rounded-md pl-10 py-2 text-sm" placeholder="john@example.com" />
                        @error('email')
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="forgot-password.html" class="text-sm font-medium text-blue-500 hover:text-green-500">Forgot your password?</a>
                </div>
            ...
            {{-- <div class="mt-6 flex items-center justify-center">
                <a href="login.html" class="text-sm font-medium text-blue-500 hover:text-green-500">Already have an account?</a>
            </div> --}}
        </div>
    </main>
</body>
